...
<body>
    <div class="container">
        ...
        <main>
            <aside>
                <ul>
                    <li><a href="tienda"><i class="fa-solid fa-store"></i>Inicio</a></l>
                    ...
                    <li><a href="ventas"><i class="fa-solid fa-cash-register"></i>Ventas</a></li>
                </ul>
            </aside>
